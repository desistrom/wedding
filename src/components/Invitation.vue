      ...
      <div class="invitation-cover">
        <div class="cover-content" :class="{'invitation-up':isOpening}">
          <div class="content-inside">
            <img class="content-inside-photo" src="../images/photo1-min.png">
            <p>we are getting married!</p>
            <p><b>Jun & Bibit</b></p>
            <p>Date：Sept, 07 2023</p>
            <p>Location：<b><a href="https://www.google.com/maps/place/7%C2%B007'47.5%22S+111%C2%B047'01.6%22E/@-7.1298484,111.782983,18z/data=!3m1!4b1!4m4!3m3!8m2!3d-7.12985!4d111.783771?entry=ttu" target="_blank">Mayangrejo, Kalitidu Bojonegoro</a></b></p>
            <div class="content-inside-bless">
              <input
                ...
                ref="wishInput"
              >
              <p v-if="!wish && isFocused && hasEntered">Please enter greeting</p>
              <div>
                <button @click="sendBarrage">Send greeting</button>
